<?php
// MAKES REQUESTS AND LOGS THEM IN momocollection.json with help of a callback file called momocollectionurl.php
...
$url = 'https://anabelle-untrapped-zana.ngrok-free.dev/momo2/momocallbackurl.php';
