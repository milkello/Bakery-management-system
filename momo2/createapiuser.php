...
// $secodary_key = "6351245fc7ca4e70b31e5844e5e7a964";
// echo "Reference ID: " . $reference_id . "<br>";
// echo "Callback URL: http://localhost/momo2/momocallbackurl.php <br>";
// Set the request URL and data
$url = 'https://sandbox.momodeveloper.mtn.com/v1_0/apiuser';
$data = array(
  'providerCallbackHost' => 'http://localhost/momo2/momocallbackurl.php'
);
// Set the headers
$headers = array(
