...
<body class="bg-gray-900 text-white min-h-screen flex">
    ...
    <div class="sidebar w-20 hover:w-64 bg-gray-800 fixed h-full overflow-hidden transition-all duration-300 z-50">
        ...
        <nav class="mt-8">
            <a href="index.html" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-lime-400 transition-colors">
                <i data-feather="pie-chart" class="w-5 h-5"></i>
                <span class="ml-4 hidden lg:block">Dashboard</span>
            </a>
            <a href="employees.html" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-lime-400 transition-colors">
                <i data-feather="users" class="w-5 h-5"></i>
                <span class="ml-4 hidden lg:block">Employees</span>
            </a>
            <a href="payroll.html" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-lime-400 transition-colors">
                <i data-feather="dollar-sign" class="w-5 h-5"></i>
                <span class="ml-4 hidden lg:block">Payroll</span>
            </a>
            <a href="inventory.html" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-lime-400 transition-colors">
                <i data-feather="package" class="w-5 h-5"></i>
                <span class="ml-4 hidden lg:block">Inventory</span>
            </a>
            <a href="schedule.html" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-lime-400 transition-colors">
                <i data-feather="calendar" class="w-5 h-5"></i>
                <span class="ml-4 hidden lg:block">Schedule</span>
            </a>
            <a href="settings.html" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-lime-400 transition-colors">
